                ...
                <form class="mx-3" @submit.prevent="submitForm">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="password-wrapper">
                            <input :type="isPasswordVisible ? 'text' : 'password'" id="password-field"
                                class="form-control h-43 mb-2" placeholder="Enter Your Password" v-model="password"
                                required />
                    ...
                    <div class="d-flex justify-content-start">
                        <div class="mb-2 form-check">
                            <input type="checkbox" class="form-check-input" id="terms" v-model="agreeToTermsChecked">
                    ...
                    <p class="fs-14 text-center mb-2">Already Have Account? <a href="/login" class="garis-">Login
                            Here</a></p>
                </form>
            </div>
        </div>
