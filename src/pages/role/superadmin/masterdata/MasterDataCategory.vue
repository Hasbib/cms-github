                    ...
                    <div class="col-md-12 mt-4 mt-md-0">
                        <div class="cbg-card rounded-3 p-4 border-0">
                            ...
                            <div class="d-flex justify-content-between mb-3 mt-4">
                                ...
                                <ButtonBiru class="fs-16 px-3 rounded-3 h-40" @click="showAddCategoryModal">Add Category
                                </ButtonBiru>
                            </div>
                    ...
                    <div class="modal-dialog custom-modal modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="d-flex justify-content-center mb-5">
                                ...
                                <ButtonBiru class="ms-3 mt-4 my-0 h-40 w-30 rounded-3 fs-16" @click="saveCategory">Save
                                </ButtonBiru>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog custom-modal modal-dialog-centered">
                        <div class="modal-content pt-3">
                            ...
                            <div class="d-flex justify-content-center mb-5">
                                ...
                                <ButtonMerah class="ms-3 my-0 h-40 w-30 rounded-3 fs-16" @click="deleteCategory">Yes,
                                    Delete</ButtonMerah>
                            </div>
                        </div>
                    </div>
