...
const showEditLevelCourseModal = () => {
    form.value.name = currentLevelCourse.value.name;
    form.value.point_course_content = currentLevelCourse.value.point_course_content;
    form.value.point_assignment = currentLevelCourse.value.point_assignment;
    form.value.point_quiz = currentLevelCourse.value.point_quiz;
    form.value.point_course_completion = currentLevelCourse.value.point_course_completion;
                        ...
                        <div class="modal-content">
                            ...
                            <div class="ps-3 pe-4 mt-3 mb-2">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <label for="categoryName" class="fs-16 mb-0 mt-2">Point Quiz</label>
                                    <input type="text" id="categoryName" class="form-control c-border w-66 h-43"
                                        placeholder="Point Quiz" v-model="currentLevelCourse.point_quiz" />
                                </div>
                                <div class="d-flex justify-content-between mt-3">
