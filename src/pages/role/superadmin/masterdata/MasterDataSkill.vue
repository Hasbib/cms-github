                        ...
                        <div class="modal-content">
                            ...
                            <div class="ps-3 pe-4 mt-3 mb-2">
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    ...
                                    <input type="text" id="categoryName" class="form-control c-border w-66 h-43 ms-4"
                            ...
                            <div class="d-flex justify-content-center mb-5">
                                ...
                                <ButtonBiru class="ms-3 mt-4 my-0 h-40 w-30 rounded-3 fs-16" @click="submitSkillForm">
                                    Save</ButtonBiru>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog custom-modal modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="d-flex justify-content-center mb-5">
                                ...
                                <ButtonBiru class="ms-3 mt-4 my-0 h-40 w-30 rounded-3 fs-16" @click="saveUpdateSkills">
                                    Save</ButtonBiru>
                            </div>
                        </div>
                    </div>
